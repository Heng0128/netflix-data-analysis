...
2. **增长趋势**: 2019 年达到发布峰值 (1,999 部)，随后略有下降
3. **地域分布**: 美国为最大制片国 (3,211 部)，其次是印度 (1,008 部)
4. **流派偏好**: Dramas (1,600 部) > Comedies (1,210 部) > Action & Adventure (859 部)
5. **年龄分级**: TV-MA (成人内容) 最多 (3,211 部)，其次是 TV-14 (2,160 部)
6. **时长特征**: 电影平均时长 99.5 分钟，电视剧多为 1-2 季
7. **相关性**: release_year 与 year_added 呈正相关 (r=0.65)，表明新内容更近期上线
8. **异常值**: 检测到 8 部时长异常作品，已标记但不影响整体分析
